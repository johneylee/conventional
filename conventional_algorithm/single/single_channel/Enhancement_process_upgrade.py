...
for i in range(len(infile_name)):
    ...
    EST_TYPE = 3  # 0: spectral subtraction, 1: power subtraction, 2: Wiener, 3: MMSE-STSA, 4: ML, 5: MLSD, 6:MLSD TEST 7:MMSE-LSA
    ...
    scipy.io.wavfile.write(filepath + os.sep + file_name + '_MMSE.wav', fs, np.asarray(enhanced_signal, dtype=np.int16))
