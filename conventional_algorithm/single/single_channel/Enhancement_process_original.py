...
infile_name = 'SA1_babble_0dB.wav'
outfile_name = 'enhanced_babble_ml.wav'
clean_name = 'SA1.wav'
...
EST_TYPE = 0                # 0: spectral subtraction, 1: power subtraction, 2: Wiener, 3: MMSE-STSA, 4: ML, 5: MLSD, 6:MLSD TEST 7:MMSE-LSA
